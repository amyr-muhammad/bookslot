    ...
    return (
        <>
            <div className="py-5 px-6 sm:px-10 lg:px-20">
                ...
                <h2 className="font-bold text-2xl sm:text-3xl lg:text-4xl mb-2 text-amber-50">How it works</h2>
                <p className="text-base sm:text-lg lg:text-xl mb-10 text-gray-300">Just Three steps! No technical knowledge needed.</p>
