...
const Hero = () => {
    return (
        <>
            <section className="h-[91.9vh] bg-[#1d1d1c] text-amber-50 grid grid-cols-2 justify-around px-20">
                <section className="flex flex-col items-start justify-center w-150 p-10 ">
                    ...
                    <button className="bg-amber-600 px-6 py-1 rounded-3xl mb-5  cursor-pointer" >Build your page free</button>
                </section>
                <section>
                    <img src="src/assets/images/prototype.png" alt="" className="w-140" />
                </section>
            </section>
